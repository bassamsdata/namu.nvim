...
local function command_callback(input)
  ...
  if not subcommand or subcommand == "" then
    vim.notify("Usage: Selecta <subcommand> [args]\nTry 'Selecta help' for more information", vim.log.levels.WARN)
    return
  end
...
vim.api.nvim_create_user_command("Selecta", command_callback, {
  nargs = "+",
  complete = command_complete,
  desc = "Selecta plugin command with subcommands. Use 'Selecta help' for more information",
})
