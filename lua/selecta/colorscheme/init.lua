...
local function setup_persistence(callback)
  ...
  uv.fs_mkdir(plugin_dir, 493, function(err) -- 493 is equivalent to 0755 permissions
    ...
    local file_exists = uv.fs_stat(selecta_color_persist)
...
vim.g.SCHEME = %q -- Initial colorscheme from setup
...
vim.api.nvim_create_autocmd("ColorScheme", {
  callback = function(params)
    vim.g.SCHEME = params.match
      ...
      uv.fs_open(selecta_color_persist, "w", 438, function(open_err, fd) -- 438 is 0666 permissions
        if open_err then
          vim.schedule(function()
